...
void ManyHist::getDpT()
{
	...
	ManyHist::labelvHist(spect_pp, r_title, dptr_title);
	ManyHist::labelvHist(spect_PbPb, r_title, dptr_title);


}


void ManyHist::getRDpT()
{
	...
	ManyHist::labelvHist(spect_rdpt, r_title, rdptr_title);

}


void ManyHist::getDeltaDpT()
{
	...
	ManyHist::labelvHist(spect_deltadpt, r_title, deltadptr_title);
}

TH1* ManyHist::cumulateR(TH1* hist)
{
...
void ManyHist::getJetShape()
{
	...
	ManyHist::labelvHist(spect_lowpt_integ_rdpt, r_title, lowpt_integ_rdpt_title);
	ManyHist::labelvHist(spect_lowpt_integ_deltadpt, r_title, lowpt_integ_deltadpt_title);
	ManyHist::labelvHist(spect_jetshape_rdpt, r_title, jetshape_rdpt_title);
	ManyHist::labelvHist(spect_jetshape_deltadpt, r_title, jetshape_deltadpt_title);

	ManyHist::labelvHist(spect_lowpt_integ_PbPb, r_title, lowpt_integ_dptr_title);
	ManyHist::labelvHist(spect_lowpt_integ_pp, r_title, lowpt_integ_dptr_title);
	ManyHist::labelvHist(spect_jetshape_PbPb, r_title, jetshape_dptr_title);
	ManyHist::labelvHist(spect_jetshape_pp, r_title, jetshape_dptr_title);

}


void ManyHist::writeToFile()
{
...
void ManyHist::labelvHist(vector<vector<vector<TH1*>>> vvv_hist, string x_label, string y_label)
{
	for (int i = 0; i < vvv_hist.size(); i++) ManyHist::labelvHist(vvv_hist[i], x_label, y_label);
}


void ManyHist::labelvHist(vector<vector<TH1*>> vv_hist, string x_label, string y_label)
{
	for (int i = 0; i < vv_hist.size(); i++) {ManyHist::labelvHist(vv_hist[i], x_label, y_label);}
}

void ManyHist::labelvHist(vector<TH1*> v_hist, string x_label, string y_label)
{
	for (int i = 0; i < v_hist.size(); i++) {ManyHist::labelvHist(v_hist[i], x_label, y_label);}
}

void ManyHist::labelvHist(TH1* hist, string x_label, string y_label)
{
...
void ManyHist::loadFiles(int config)
{
	...
	output_file = new TFile(Form("output_%s_%s.root",file_path.c_str(), dataType.c_str()), "recreate");
}
